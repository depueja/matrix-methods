#libraries to install. also, install Pillow w/
...
#load an image
image_path = r'C:\projects\learning projects\LEARNING PYTHON\fun projects\greyscale_cat.jpeg'
...
#convert to np array
a = np.array(im)
#now, make it greyscale by removing third axis
b = np.mean(a, 2)
